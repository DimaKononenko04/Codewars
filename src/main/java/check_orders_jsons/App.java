...
public class App {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Gson gson = new Gson();
        String ordersCreatedFilePath = PropertiesManager.getPropertyValueByName("jsonFile","orders_created_json_set");
        String initialOrders = PropertiesManager.getPropertyValueByName("jsonFile","initial_orders");
